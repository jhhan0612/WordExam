...
public class TestKorean extends Activity implements OnClickListener{
	...
	public void setQuestion(int testnum, TextView question, ArrayList<String> englist, ArrayList<Integer> lamdom){
		question.setText(englist.get(lamdom.get(testnum)));
	}
